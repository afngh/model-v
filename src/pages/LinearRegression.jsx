...
import Explanation from '../components/linear/Explanation';
import Visualization from '../components/linear/Visualization';

const LinearRegression = () => {
  const [activeTab, setActiveTab] = useState('explanation'); // 'explanation' or 'visualization'
